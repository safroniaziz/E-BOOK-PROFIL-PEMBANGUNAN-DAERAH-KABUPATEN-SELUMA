                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="col-span-1 ">
                        <div
                            ...
                            <div class="   w-full mx-auto     items-center  inline-flex  bg-gradient-to-r   px-5 py-2.5 my-4 font-bold text-sm text-white    from-[#096914]     to-lime-400">
                                <div class="mx-auto flex space-x-5">
                                    <p class="link flex space-x-2 mt-1 ">Followers <span class="font-extrabold text-xl ml-3 -mt-1">0</span> </p>
                                    <p class="link flex space-x-2  mt-1 ">Datasets <span class="font-extrabold text-xl ml-3 -mt-1">11</span> </p>
                    ...
                    <div class="col-span-1 lg:col-span-3 ">
                        ...
                        <div
                            ...
                            <div class="p-5 rounded-lg border border-gray-300   bg-gray-100 shadow-inner shadow-gray-400 ml-5">
