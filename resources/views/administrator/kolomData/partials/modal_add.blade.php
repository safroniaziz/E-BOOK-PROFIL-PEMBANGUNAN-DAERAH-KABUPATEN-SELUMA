<div class="modal fade" id="modalTambah">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('kelompokDataSektoral.store') }}" method="POST" class="form" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" id="kelompok_data" name="kelompok_data">
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="deskripsi_singkat" class="form-control" id="" cols="30" rows="3"></textarea>
                        </div>

                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1">Dokumen PDF</label>
                            <input type="file" class="form-control" id="dokumen_pdf" name="dokumen_pdf">
                        </div>

                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1">Dokumen Word</label>
                            <input type="file" class="form-control" id="dokumen_word" name="dokumen_word">
                        </div>
                    </div>
                </div>
