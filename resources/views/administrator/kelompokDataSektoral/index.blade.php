                    ...
                    <tbody>
                        @foreach ($kelompokDataSektorals as $index => $kelompokDataSektoral)
                            <tr>
                                ...
                                <td>{{ $kelompokDataSektoral->sumber_data }}</td>
                                <td>{{ $kelompokDataSektoral->deskripsi_singkat }}</td>
                                <td>
                                    @if ($kelompokDataSektoral->dokumen_pdf != null)
                                        <a class="" href="{{ route('kelompokDataSektoral.downloadPdf',[$kelompokDataSektoral->id]) }}">
                                            Download
                                        </a>
                                    @else
                                        <a class="text-danger">tidak ada file</a>
                                    @endif
                                </td>
                                <td>
                                    @if ($kelompokDataSektoral->dokumen_pdf != null)
                                        <a class="" href="{{ route('kelompokDataSektoral.downloadWord',[$kelompokDataSektoral->id]) }}">
                                            Download
                                        </a>
                                    @else
                                        <a class="text-danger">tidak ada file</a>
                                ...
                                <td>
                                    <a href="{{ route('kelompokDetail',[$kelompokDataSektoral->id]) }}">{{ $kelompokDataSektoral->kelompok_details_count }} Data</a>
                                </td>
                                <td>
                                    <table>
                                        <tr>
