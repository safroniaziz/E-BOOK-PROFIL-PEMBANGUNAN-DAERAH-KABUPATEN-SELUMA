    ...
    <div class="font-[Poppins] 2xl:text-xl font-nunito text-slate-900 overflow-x-hidden w-full">
                    ...
                    <div x-cloak :class="[isOpen ? '  opacity-100 block' : 'opacity-0  hidden']"
                        ...
                        <div class="flex flex-col -mx-6 lg:flex-row lg:items-center text-[16px]">
                            ...
                            <a href="{{ route('tentang') }}"
                                class="px-2 py-2 active-menu mx-2 mt-2  text-gray-600 lg:text-black font-bold text-[14px] text-sh   duration-300 transform rounded-md lg:mt-0   ">Tentang</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="home">
            <div class="text-center overflow-hidden bg-gradient-to-br   from-[#096914] to-lime-200">
                <div
                    class="  z-10  mt-32 mb-20 lg:mt-40 overflow-hidden container mx-auto section-heading ">

                <h2 data-aos="fade-down" class="mb-6 text-center font-sans text-4xl lg:text-5xl 2xl:text-6xl font-extrabold text-green-900   "
                ...
                <div class="custom-shape-divider-bottom-1701011978">
                    <svg class="fill-white lg:h-24 2xl:w-32 h-10" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
        ...
        <!-- end slider -->
         ...
         <!-- content  -->
        <section id="content">
            <div class="mx-auto container bg-white shadow-lg   rounded-lg  lg:px-14  px-5 py-32 text-gray-800 z-10 relative text-sm leading-7  ">
                Seluma adalah sebuah wilayah kabupaten di provinsi Bengkulu, Indonesia. Kabupaten Seluma terbentuk berdasarkan Undang-Undang Nomor 3 Tahun 2003. Kabupaten Seluma merupakan pemekaran dari Kabupaten Bengkulu Selatan.

                <h2 class="text-2xl font-bold my-3">
                    Apa itu E-book profil pembangunan daerah Seluma
                </h2>
                <p class="text-sm leading-8">
                    Disrupsi era digital saat ini tidak bisa dipisahkan dari penggunaan data. Open Government, Data-Driven Decisions, dan Transparency merupakan beberapa hal yang tengah disorot saat ini dan secara tidak langsung mendorong pemerintah untuk secara adaptif dan kreatif memanfaatkan transformasi digital dalam upaya meningkatkan performa pelayanan publik berbasis data bagi masyarakat. Sehubungan dengan hal tersebut, E-book profil pembangunan daerah Seluma hadir sebagai portal data terbuka yang menyediakan data akurat dari seluruh Organizations perangkat daerah di Kabupaten Seluma.<br><br>

                    Didasarkan atas Peraturan Presiden No 39 Tahun 2019 Tentang E-book profil pembangunan daerah Indonesia, ketersediaan E-book profil pembangunan daerah Seluma diharapkan dapat meningkatkan ketersediaan data pemerintah yang akurat dan terbuka untuk secara mudah diakses oleh masyarakat dalam sebuah portal data resmi milik Pemerintah Kabupaten Seluma.
                </p>
                <h2 class="text-2xl font-bold my-3">
                    Mekanisme Pengumpulan Data
                </h2>
                <p class="text-sm leading-8">
                    E-book profil pembangunan daerah Seluma dikelola oleh Diskominfo Seluma sebagai walidata dari seluruh data yang ada di Pemerintah Kabupaten Seluma. Data yang tersedia pada E-book profil pembangunan daerah Seluma adalah data yang bersifat Publik dan dapat diakses secara langsung oleh masyarakat umum.
                </p>
            </div>
        </section>
        <!-- end content  -->
        ...
        <div class="relative">
            ...
            <div class="slider-svg-b tran-svg absolute -mt-2 z-10">
                <svg data-name="Layer 1" class="svg6 duration-300 transform fill-white"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                    <path
                        d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z"
                        class="shape-fill"></path>
