                    ...
                    <div x-cloak :class="[isOpen ? '  opacity-100 block' : 'opacity-0  hidden']"
                        ...
                        <div class="flex flex-col -mx-6 lg:flex-row lg:items-center text-[16px]">
                            ...
                            <a href="{{ route('showcase') }}"
                                class="px-2 py-2 active-menu mx-2 mt-2  text-gray-600 lg:text-black font-bold text-[14px] text-sh   duration-300 transform rounded-md lg:mt-0   ">showcase</a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="col-span-1 ">
                        <div class="bg-white shadow-gray-300 shadow-lg  mb-5 rounded-lg     p-5   text-gray-800  text-sm leading-7">
                            <h2 class="text-xl font-bold my-3 border-b border-gray-200 pb-2">
                                What are Showcases?
                            </h2>
                            <p class="text-sm leading-8">
                                Datasets have been used to build apps, websites and visualizations. They've been
                                featured in articles, and written about in news reports and blog posts. Showcases
                                collect together the best examples of datasets in use, to provide further insight,
