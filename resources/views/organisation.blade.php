                    ...
                    <div x-cloak :class="[isOpen ? '  opacity-100 block' : 'opacity-0  hidden']"
                        ...
                        <div class="flex flex-col -mx-6 lg:flex-row lg:items-center text-[16px]">
                            ...
                            <a href="{{ route('organisation') }}"
                                class="px-2 py-2 active-menu mx-2 mt-2 text-gray-600 lg:text-black font-bold text-[14px] text-sh   duration-300 transform rounded-md lg:mt-0   ">Organizations</a>
                            <a href="{{ route('group') }}"
            ...
            <div class="container mx-auto">
                <div class="grid grid-cols-1   lg:grid-cols-3 gap-6">
                    <div class="col-span-1 ">
                        <div
                            class="bg-white shadow-gray-300 shadow-lg  mb-5 rounded-lg     p-5   text-gray-800  text-sm leading-7">
                            <h2 class="text-xl font-bold my-3 pb-2 border-b border-gray-200">
                                What are Organizations?
                            </h2>
                            <p class="text-sm leading-8">
                                CKAN Organizations are used to create, manage and publish collections of datasets. Users
                                can have different roles within an Organization, depending on their level of
                                authorisation to create, edit and publish.
                            </p>
                        </div>
                    ...
                    <div class="col-span-1 lg:col-span-2 ">
                        ...
                        <div
                            ...
                            <div x-data class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <a href="{{ route('organisation_detail') }}"
                                    ...
                                    <a href="organizations_detail.html"
                                        ...
                                        <div class="w-2/3   flex flex-col   p-3">
                                            ...
                                            <h3 class="font-black text-gray-800  text-lg line-clamp-2 group-hover:text-yellow-600 duration-300 transform">Dinas Pertanian  </h3>
                                            <p class="text-sm text-gray-500 leading-7 line-clamp-4 italic">There is no description for this organization </p>
                                    ...
                                    <a href="organizations_detail.html"
                                        ...
                                        <div class="w-2/3   flex flex-col   p-3">
                                            ...
                                            <h3 class="font-black text-gray-800  text-lg line-clamp-2 group-hover:text-yellow-600 duration-300 transform">Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic quas suscipit maxime vel pariatur, tempora reiciendis, eligendi culpa ut consequuntur consequatur minima porro dolores architecto laudantium id quidem voluptas soluta?  </h3>
                                            <p class="text-sm text-gray-500 leading-7 line-clamp-4  ">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus iste iure nemo expedita, inventore ipsa et reprehenderit explicabo dolor numquam quasi facilis eligendi sit ipsam exercitationem molestiae minima est tempore. </p>
